...
CREATE DATABASE [Testapp2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Testapp2', FILENAME = N'D:\test\Testapp2.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Testapp2_log', FILENAME = N'D:\test\Testapp2_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
